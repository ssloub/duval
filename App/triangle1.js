...
const legendTexts = [
    ...
    "T3 = Thermal fault < 300\u00B0C",
    "D1 = Thermal fault T > 700\u00B0C",
...
function findAndDisplayColor(color) {
    ...
    if (color.r == 255 && color.g == 0 && color.b == 0) {
        ...
        diagResult = "T1 = Thermal fault < 300\u00B0C";
    } else if (color.r == 255 && color.g == 204 && color.b == 0) {
        diagResult = "T2 = Thermal fault 300\u00B0C < T < 700\u00B0C";
    } else if (color.r == 0 && color.g == 0 && color.b == 0) {
        diagResult = "T3 = Thermal fault < 300\u00B0C";
    } else if (color.r == 172 && color.g == 236 && color.b == 222) {
        diagResult = "D1 = Thermal fault T > 700\u00B0C";
